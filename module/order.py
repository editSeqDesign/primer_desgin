...
#引物合并
def merge_primer(uha_primer_df,dha_primer_df,sgRNA_primer_df,plasmid_backbone_p_df,seq_altered_p_df,plasmid_sequencing_primer_df,genome_sequencing_primer_df):
